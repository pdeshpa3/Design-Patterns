...
public class MyLogger{
    ...
    public static enum DebugLevel { CONSTRUCTOR, FILE_PROCESSOR, MODIFY_PROCESSOR, UPDATE_RECORD, NONE
    };
    ...
    public static void setDebugValue (int levelIn) {
        switch (levelIn) {
            ...
            case 3: debugLevel = DebugLevel.MODIFY_PROCESSOR; break;
            case 4: debugLevel = DebugLevel.UPDATE_RECORD;
