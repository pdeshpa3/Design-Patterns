...
public class MildlyPopular extends AbstractState {
    ...
    public MildlyPopular(ChannelContext context, Results results){super.channelContext = context; super.results = results;}
    ...
    public String toString() {
        return StateName.MILDLY_POPULAR.toString()+"_";
    }
}
