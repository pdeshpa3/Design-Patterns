...
public class UltraPopular extends AbstractState {
    ...
    public UltraPopular(ChannelContext context, Results results){super.channelContext = context; super.results = results;}
    ...
    public String toString() {
        return StateName.ULTRA_POPULAR.toString()+"_";
    }
}
